...
routes = [
  ...
  # TODO: verify body style of these reference routes (R1T vs R1S) — provisionally R1T after the split
  CarTestRoute("bc095dc92e101734/000000db--ee9fe46e57", RIVIAN.RIVIAN_R1T),
  CarTestRoute("c70d59e4150956fc/0000006e--48bfbfda01", RIVIAN.RIVIAN_R1T), # GEN2
